...
The scalar Tate readout erased this orientation line. The correct candidate is
a two-term graded carrier joining the even vacuum to its odd derivative
companion. Its global completion and zero-to-state bridge remain open.

Research packet:
`research/grothendieck/the-orientation-line-restores-the-odd-tate-port-without-changing-global-character.md`

Epistemic graph admission: event `8951`.
