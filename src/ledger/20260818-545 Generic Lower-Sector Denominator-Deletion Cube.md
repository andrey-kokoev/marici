...
- not, from this calculation alone, a proper full-support grade;
- not evidence for a new carrier stratum.

The low-face counts show that denominator deletion gives a nontrivial
coefficient filtration already before any canonical-basis choice.
...
- exact zero-support rank \(7\);
- one exact single-pole rank \(12\);
- one finite-pair rank \(18\);
- the parallel-pair rank \(17\);
- full-family rank \(34\) at two independent exact fibers.

Not established:

- the complete sixteen-face Boolean deletion cube;
...
In particular, the remaining face ranks must not be inferred merely from the
known collision pattern.

## Next finite falsifier

Compute the remaining Boolean-face ranks at a generic exact fiber and perform
Möbius inversion. Then construct geometric representatives for every
nonzero proper grade and test whether all connecting maps are generated by
the frozen denominator/Cayley--Menger incidence.
...
~~~json
{
  ...
  "complete_deletion_cube": false,
  "proper_full_support_grade": "uncomputed",
  "new_carrier_datum": false,
  "next_experiment": "Complete the sixteen-face deletion cube and construct its nonzero proper-grade connecting maps."
}
~~~
