# The Logarithmic Hermite Phase Is Not the Tate Sheet Phase

Entry 3944 correctly proved that the logarithmic Hermite witness separates the
Mellin endpoint from every nonzero translate. It incorrectly used
...
Research packet:
`research/grothendieck/the-logarithmic-hermite-phase-is-not-the-tate-sheet-phase.md`

Epistemic graph admission with the successor result: event `8935`.