...
result = {
    ...
    "F_prime_real_part_lower_on_radius_nine": str(F_prime_real_lower),
    "upper_half_disk_pick_margin_per_unit_height": str(F_prime_real_lower),
    "Im_F_strictly_positive_on_upper_radius_nine_disk": True,
...
if __name__ == "__main__":
    output = ROOT / "results" / "central-complex-pick-radius-nine-certificate.json"
