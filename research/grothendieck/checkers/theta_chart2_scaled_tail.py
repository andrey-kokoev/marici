"""Exact Cauchy majorants for degree>=14 tails of scaled Chart-2 H and J."""
from fractions import Fraction as F
from math import factorial
from pathlib import Path
import json
q0,q1=F(7,16),F(1,2);p0=F(2*3141592653589793238,10**18);p1=F(2*3141592653589793239,10**18)
R0=F(1,4);r=F(1,64);rho=r/R0;Amin=p0/q1;Amax=p1/q0
...
result={"scope":"uniform exact Cauchy majorants on complex |z|<=1/4",
 ...
 "H_tail_below_margin":Htail<F(1645),"J_tail_below_margin":Jtail<F(5325,1000)}
assert result["H_tail_below_margin"] and result["J_tail_below_margin"]
out=json.dumps(result,indent=2)+"\n";Path("research/grothendieck/results/theta-chart2-scaled-tail.json").write_text(out);print(out,end="")
