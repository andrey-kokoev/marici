...
mp.mp.dps=40
ZEROS=np.array([float(mp.im(mp.zetazero(k))) for k in range(1,21)])
H=math.floor(ZEROS[-1]); TS=np.geomspace(.02,3,120);XS=np.linspace(0,25,251)
