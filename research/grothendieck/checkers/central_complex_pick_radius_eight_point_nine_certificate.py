...
assert F_prime_real_lower > D("0.0007")
...
result = {
    ...
    "normalized_C_modulus_lower_on_radius_8_point_9": str(denominator_lower),
    ...
    "F_prime_real_part_lower_on_radius_8_point_9": str(F_prime_real_lower),
    "upper_half_disk_pick_margin_per_unit_height": str(F_prime_real_lower),
    "Im_F_strictly_positive_on_upper_radius_8_point_9_disk": True,
...
if __name__ == "__main__":
    output = ROOT / "results" / "central-complex-pick-radius-eight-point-nine-certificate.json"
