#!/usr/bin/env python3
"""Exact reflection invariance of the eight-point NMHV BCFW representation."""
...
configs=[(1,2,4,7,11,16,22,29),(0,1,3,8,14,23,35,50),(-4,-2,1,5,12,20,31,45)]
def evaluate(ts):
