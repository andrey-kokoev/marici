...
# This file was *autogenerated* from the file research/nima/check_kallen_physical_endpoint_no_go.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_4 = Integer(4)
import json
import hashlib

R = PolynomialRing(QQ, names=('A', 'B', 'T', 'z',)); (A, B, T, z,) = R._first_ngens(4)
f = A*z**_sage_const_2 -(A+B-T)*z+B
Q = _sage_const_4 *A*B-(A+B-T)**_sage_const_2 
...
assert kallen['generic_cover_degree'] == _sage_const_2 
