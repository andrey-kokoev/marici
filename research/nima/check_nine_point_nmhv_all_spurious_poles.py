#!/usr/bin/env python3
"""Exact cancellation of every spurious pole in nine-point NMHV BCFW."""
...
def check_divisor(target):
 e=s.Symbol('epsilon');base={i:s.Matrix([1,s.Integer(t),s.Integer(t)**2,s.Integer(t)**3]) for i,t in enumerate((1,2,4,7,11,16,22,29,37),1)}
