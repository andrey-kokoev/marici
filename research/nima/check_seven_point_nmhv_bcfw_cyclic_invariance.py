#!/usr/bin/env python3
"""Exact cyclic invariance of the seven-point NMHV BCFW representation."""
...
configs=[(1,2,4,7,11,16,22),(0,1,3,8,14,23,35),(-4,-2,1,5,12,20,31)]
def evaluate(ts):
