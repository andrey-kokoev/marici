#!/usr/bin/env python3
"""Exact projectivity of the ten-point planar scattering 4-form."""
import json,sys
...
import sympy as s
N=10;coords=s.symbols('x3:10');C={(i,j):s.Symbol(f'c{i}{j}') for i in range(1,N-1) for j in range(i+2,N)}
