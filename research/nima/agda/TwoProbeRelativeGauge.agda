...
open import Cubical.Data.Empty.Base using (ot)
open import Cubical.Data.Sigma.Base using (_	imes_)
...
twist-twice : (x : R.Point) -> R.pull T.twist-filler (\lambda y -> R.pull T.twist-filler (\lambda z -> z) y) x \equiv x
...
swap-twice-fst : (x : R.Point) -> R.pull B.swap-filler (R.pull B.swap-filler R.fst) x \equiv R.fst x
swap-twice-fst x = refl

swap-twice-snd : (x : R.Point) -> R.pull B.swap-filler (R.pull B.swap-filler R.snd) x \equiv R.snd x
