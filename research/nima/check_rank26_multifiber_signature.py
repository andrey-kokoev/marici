...
def main():
    ...
    payload = {
        ...
        "common_support_pattern": all(item["second_fundamental_form_supports"] == samples[0]["second_fundamental_form_supports"] for item in samples),
