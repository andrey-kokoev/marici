...
RES=ROOT/'research'/'voevodsky'/'results'; A=rees.AMBIENT; OUT=RES/f'cosmology_rank26_p_normal_K_q_boundary_signatures_p{base.PRIME}_a{A}.json'
...
def main():
 ...
 out={'schema':'marici.voevodsky.cosmology-rank26-p-normal-K-q-boundary-ambient-signatures.v1','status':'boundary_signatures_extracted','field':base.PRIME,'ambient_relation_degree':A,'boundary_degrees':[A-6,A-5,A-4],'records':records,'passed':True}
