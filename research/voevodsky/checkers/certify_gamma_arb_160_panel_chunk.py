#!/usr/bin/env python3
"""Directed rank-160 gamma integral on a resumable real-frequency panel chunk."""
import json,sys
...
for left in range(start,stop,10):
 a=arb(left);b=arb(min(left+10,stop))
 for k in range(Q):
