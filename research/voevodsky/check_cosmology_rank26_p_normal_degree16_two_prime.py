"""Two-prime ambient-degree-16 quotient-rank audit for p-normal rank-26 rows."""
...
OUT = VOE_RESULTS / "cosmology_rank26_p_normal_degree16_two_prime.json"
...
def main() -> None:
    for filename in [
        ...
        "cosmology_rank26_p_normal_degree14_two_prime.json",
    ]:
    ...
    result = {
        "schema": "marici.voevodsky.cosmology-rank26-p-normal-degree16-two-prime.v1",
        "status": "degree16_two_prime_p_tangent_quotient_absorbs_raw_p_normal_derivatives",
        "rechecked_inputs": [
        ...
        "interpretation": "At ambient degree 16, both primes give identical quotient-rank absorption. The p-normal derivative image still vanishes modulo the special exact image plus p-tangent derived span.",
        "limitations": [
            "finite cutoff at ambient relation degree 16 only",
