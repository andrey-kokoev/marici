...
required={'refine_seam','massive_apply','green_resolve','endpoint_moments','include_contexts','project_contexts','green_determinant_transition','paired_pfaffian_transition'}
