...
required={'refine_seam','massive_apply','green_resolve','endpoint_moments','include_contexts','project_contexts','green_determinant_transition','paired_pfaffian_correspondence','paired_pfaffian_transition','integral_torsion_reconcile','localize_torsion','tropical_torsion_update','tail_observe'}
...
rids={x['id'] for x in d['relations']};assert {'massive_green_factorization','ind_pro_triangle','determinant_cocycle','paired_pfaffian_correspondence','paired_pfaffian_transition','moment_kernel_stability','integral_pfaffian_divisor_classification','graded_tropical_recurrence','tail_observer_duality'}<=rids
