...
fn fiber_census(x:i64,y:i64,z:i64)->String{
 ...
 format!("{{\"fiber\":[{},{},{}],\"shared_three_rows\":[{}],\"complete_five_rows\":[{}]}}",x,y,z,show(&rows3),show(&rows5))
}
fn main(){
 let a=fiber_census(2,3,4);let b=fiber_census(3,5,7);
 println!("{{\"schema\":\"marici.shared_wall_log_syzygy_census.v3\",\"prime\":{},\"samples\":[{},{}],\"stable_complete_five_minimal_degree\":7,\"stable_complete_five_minimal_rank\":3}}",P,a,b);
}
