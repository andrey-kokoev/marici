...
RES=ROOT/'research'/'voevodsky'/'results';A=rees.AMBIENT;OUT=ROOT/'research'/'benincasa'/'results'/f'cosmology_boundary_correction_cell_audit_A{A-2}_to_A{A}.json'
