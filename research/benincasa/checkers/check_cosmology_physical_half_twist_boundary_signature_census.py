...
VRES=ROOT/'research'/'voevodsky'/'results'; OUT=ROOT/'research'/'benincasa'/'results'/'cosmology_physical_half_twist_boundary_signature_census.json';charts.GAMMA=-pow(2,-1,base.PRIME)%base.PRIME
def add(d,k,v):
...
def main():
 ...
 closure=json.loads((VRES/'cosmology_rank26_p_normal_K_q_lift_shift_closure.json').read_text()); assert not closure['passed']
