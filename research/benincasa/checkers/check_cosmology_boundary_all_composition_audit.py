...
RES=ROOT/'research'/'voevodsky'/'results';OUT=ROOT/'research'/'benincasa'/'results'/'cosmology_boundary_all_composition_audit.json'
def add(d,k,v):
...
def main():
 ...
 q12=json.loads((RES/'cosmology_rank26_p_normal_K_q_boundary_signatures_a12.json').read_text());q16=json.loads((RES/'cosmology_rank26_p_normal_K_q_boundary_signatures_a16.json').read_text());w14=json.loads((RES/'cosmology_rank26_p_normal_K_q_boundary_all_words_A12_to_A14.json').read_text());w16=json.loads((RES/'cosmology_rank26_p_normal_K_q_boundary_all_words_A14_to_A16.json').read_text());L14={(r['k_pole'],*r['source_exponent']):r for r in w14['records']};L16={(r['k_pole'],*r['source_exponent']):r for r in w16['records']};d14,sk14=compat.descriptors(14);d16,sk16=compat.descriptors(16);Ti={d:i for i,d in enumerate(d16)};SKi={d:i for i,d in enumerate(sk16)}
