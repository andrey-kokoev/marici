...
if __name__=='__main__':
    parser=argparse.ArgumentParser(description='Exact normalization-module extension obstruction audit')
    parser.add_argument('--output',type=Path,
        default=Path(__file__).with_name('branch_a_normalization_sheet_extension_obstruction_certificate.json'))
    main_normalization_extension(parser.parse_args().output)
