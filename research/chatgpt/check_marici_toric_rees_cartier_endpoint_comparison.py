#!/usr/bin/env python3
"""Toric Jacobian/Cartier comparison of the whole native Rees map.
...
if __name__=='__main__':
    ...
    parser.add_argument('--output',type=Path,default=Path('marici_toric_rees_cartier_endpoint_comparison_certificate.json'))
