...
if __name__=='__main__':
    parser=argparse.ArgumentParser(description='Exact all-regulator-grade conductor-costalk continuation')
    parser.add_argument('--output',type=Path,default=Path(__file__).with_name(
        'branch_a_conductor_costalk_regulator_continuation_certificate.json'))
    main_regulator_continuation(parser.parse_args().output)
